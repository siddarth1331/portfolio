  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <Image src={assets.mypic} alt="user" className="w-full rounded-3xl" />
        </motion.div>
        <motion.div
          initial={{ opacity: 0 }}
          whileInView={{ opacity: 1 }}
        ...
        >
          <p className="mb-10 max-w-2xl font-Ovo">
            Motivated tech enthusiast with hands-on experience in modern web
            technologies, striving to craft seamless user experiences.
          </p>
          <motion.ul
            initial={{ opacity: 0 }}
            whileInView={{ opacity: 1 }}
